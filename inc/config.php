...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/estudiantes/agreg_r/';
...
if ($modoInscripcion == '1'){
	...
	//$tProceso	= 'Inscripci&oacute;n de Asignaturas Estudiantes Regulares';
...
$mensajeplanilla	= "<strong>ATENCI&Oacute;N:</strong> Inicio del Lapso Acad&eacute;mico ".$lapsoProceso.": Lunes 26/10/2015.";

//$mensajeppal = "Disculpe, el proceso ha Finalizado. Si desea agregar una asignatura ingrese al modulo de Agregados";
$mensajeppal = "Disculpe, el proceso no se encuentra activo";
